...
import com.mercadolibre.dashboard.detail.di.featureDetailModule
...
val appComponent =
    listOf(createRemoteModule("http://mobile.ml.com/dashboard/"), repositoryModule, featureHomeModule, featureDetailModule, localModule)