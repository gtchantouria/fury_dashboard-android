...
public abstract class FragmentHomeBinding extends ViewDataBinding {
  @NonNull
  public final ImageView fragmentHomeImageEmptyList;

  @NonNull
  public final RecyclerView fragmentHomeRv;

  @NonNull
  public final SwipeRefreshLayout fragmentHomeSwipeToRefresh;

  @NonNull
  public final TextView fragmentHomeTextViewEmptyList;

  @Bindable
  protected HomeViewModel mViewmodel;

  protected FragmentHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ImageView fragmentHomeImageEmptyList, RecyclerView fragmentHomeRv,
      SwipeRefreshLayout fragmentHomeSwipeToRefresh, TextView fragmentHomeTextViewEmptyList) {
    super(_bindingComponent, _root, _localFieldCount);
    this.fragmentHomeImageEmptyList = fragmentHomeImageEmptyList;
    this.fragmentHomeRv = fragmentHomeRv;
    this.fragmentHomeSwipeToRefresh = fragmentHomeSwipeToRefresh;
    this.fragmentHomeTextViewEmptyList = fragmentHomeTextViewEmptyList;
  }
