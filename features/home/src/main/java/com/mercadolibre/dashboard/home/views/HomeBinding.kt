...
object HomeBinding {
    ...
    @JvmStatic fun setItems(recyclerView: RecyclerView, resource: Resource<List<Release>>?) {
    ...
    @JvmStatic fun showMessageErrorWhenEmptyList(view: View, resource: Resource<List<Release>>?) {
        if (resource!=null) {
